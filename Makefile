...
## test/api/articles_empty: run the /api application in the background, then run the tests in the ArticlesEmpty folder of the postman collection in docker and kill the api application once finished
